...
const UserPizzaDashboard = () => {
  ...
  const handleAddToCart = async (pizza) => {
    try {
      await addToCart(pizza._id, "variety", 1);
  ...
  const Header = () => {
    ...
    const getCurrentPage = () => {
      ...
      if (path === "/custom-pizza") return "custom-pizza";
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-6">
              ...
              <button
                onClick={() => handleNavigation("/custom-pizza")}
                className={`flex items-center space-x-2 px-4 py-2 rounded-xl transition-all duration-200 hover:bg-white/10 hover:shadow-lg ${
                  getCurrentPage() === "custom-pizza"
                    ? "bg-white/20 shadow-lg"
                    : ""
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-xl transition-all duration-200 hover:bg-white/10 hover:shadow-lg ${
                  getCurrentPage() === "cart" ? "bg-white/20 shadow-lg" : ""
                }`}
              >
              ...
              <div className="flex flex-col space-y-2">
                <button
                  ...
                  className={`flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-white/10 transition-colors text-left ${
                    getCurrentPage() === "dashboard" ? "bg-white/20" : ""
                  }`}
                >
                ...
                <button
                  onClick={() => handleNavigation("/custom-pizza")}
                  className={`flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-white/10 transition-colors text-left ${
                    getCurrentPage() === "custom-pizza" ? "bg-white/20" : ""
                  }`}
                >
                ...
                <button
                  onClick={() => handleNavigation("/cart")}
                  className={`flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-white/10 transition-colors text-left ${
                    getCurrentPage() === "cart" ? "bg-white/20" : ""
                  }`}
                >
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 group transform hover:-translate-y-2">
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 rounded-xl font-semibold shadow-lg transition-all duration-200 transform hover:scale-105 bg-gradient-to-r from-red-500 to-red-600 text-white hover:from-red-600 hover:to-red-700 hover:shadow-xl"
          >
